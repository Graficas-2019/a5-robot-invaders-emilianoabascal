...
function animate() {
    ...
    currentTime = now;
    var playTime = (now - startTime)/1000
    document.getElementById("time").innerHTML = playTime +" s";
    document.getElementById("points").innerHTML = "score: " + puntuacion;
    if(start == "start"){
        for(robot of robots){
